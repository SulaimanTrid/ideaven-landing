...
| 5B | M6–M8 Context Engine | ⬜ | Ask AI context assembly, diagnostics seeding | memory confirmation UX, ranked context engine, budgets |
...
| 5L | M146–M180 AI Reliability + Cost | ◐ | credits ledger, usage records | credit safety limits, loop detection, failure classification, quality metrics, human override, manual path, context palette commands, AI commands, NL navigation/search, question system, evidence, block↔code learning, error education, quality feedback, correction flow, no-false-success |
